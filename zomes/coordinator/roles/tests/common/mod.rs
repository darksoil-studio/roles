...
pub async fn sample_role_claim_1(conductor: &SweetConductor, zome: &SweetZome) -> RoleClaim {
    RoleClaim {
        role: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.".to_string(),
...
pub async fn create_role_claim(
    ...
    let record: Record = conductor.call(zome, "create_role_claim", role_claim).await;
    record
}
