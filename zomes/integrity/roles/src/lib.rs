...
pub fn validate(op: Op) -> ExternResult<ValidateCallbackResult> {
    match op.flattened::<EntryTypes, LinkTypes>()? {
                ...
                OpUpdate::Entry {
                    ...
                    match app_entry {
                        EntryTypes::RoleClaim(role_claim) => {
                            ...
                            let original_role_claim = match RoleClaim::try_from(
                                original_app_entry,
                            ) {
                                Ok(entry) => entry,
                                Err(e) => {
                                    return Ok(
                                        ValidateCallbackResult::Invalid(
                                            format!("Expected to get RoleClaim from Record: {e:?}"),
                                        ),
                                    );
                                }
                            };
        ...
        FlatOp::RegisterCreateLink {
            ...
            match link_type {
                LinkTypes::AllRoles => {
                    validate_create_link_all_roles(
                        action,
                        base_address,
                        target_address,
                        tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            match link_type {
                LinkTypes::AllRoles => {
                    validate_delete_link_all_roles(
                        action,
                        original_action,
                        base_address,
                        target_address,
